...
import 'package:jaras01/components/VimeoEmbedWidget.dart';
import 'package:jaras01/components/YouTubeEmbedWidget.dart';
    ...
    return Html(
      ...
      customRender: {
        ...
        "img": (RenderContext renderContext, Widget child) {
          ...
          return cachedImage(img).cornerRadiusWithClipRRect(defaultRadius);
        },
